...
exports.update_image_db_vendor = catchAsync(async (req, res, next) => {
  await upload
    .resizeImage(req, next, 500, 500, 98, `public/images/products`)
    .then(async (data) => {
...
exports.update_image_db_customer = catchAsync(async (req, res, next) => {
  upload.resizeImage(req, next, 500, 500, 90, `public/images`).then(async (data) => {
    // upload.resizeImage(req, next, 500, 500, 90, `public/images`).then(async (data) => {
...
exports.create_vendor_product = (req, res, next) => {
  ...
  query
    .query_data(req, next, post_product)
    .then(
      (rows) => {
